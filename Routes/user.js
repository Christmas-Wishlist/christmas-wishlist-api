...
router.get('/user', authenticateToken, isOwnerOrAdminMiddleware('User'), user.getUser); // Obtenir les informations de l'utilisateur connecté (requiert authentification)
